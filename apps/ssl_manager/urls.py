...
path('api/certificates/<int:cert_id>/update/', views.api_update_cert, name='api_update_cert'), # MỚI
    path('api/certificates/<int:cert_id>/delete/', views.api_delete_cert, name='api_delete_cert'), # MỚI
    path('api/certificates/<int:cert_id>/check-live/', views.api_check_ssl_live, name='api_check_ssl_live'), # MỚI
